                                ...
                                <div class="portlet-body">
                                            ...
                                            <div class="card-box">
                                                <div class="widget-chart">
                                                    ...
                                                    <br>
                                                       <div class="row">
                                                            <div class="col-md-2">
                                                                <span class="help-block">Servicio </span>
                                                                ...
                                                                <option value="interprovincial-express">Interprovincial Express</option>
                                                                </select>
                                                                </div>
                                                        <div class="row">
                                                            <div class="col-md-1">
                                                                <span class="help-block">Tarifa Base </span>
                                                                <input type="number" class="datos form-control" id="tarifa-base" name="tarifa-base" placeholder="" required>
                                                                </div>
                                                            <div class="col-md-1">
                                                                <span class="help-block">Km Adicional </span>
                                                                <input type="number" class="datos form-control" id="km-adicional" name="km-adicional" placeholder="" required>
                                                                </div>
                                                            <div class="col-md-1">
                                                                <span class="help-block">Peso (KG) </span>
                                                                <input type="number" class="datos form-control" id="cobertura-peso-kg" name="peso-kg" placeholder="" required>
                                                                </div>
                                                            <div class="col-md-1">
                                                                <span class="help-block">Volumen </span>
                                                                <input type="number" class="datos form-control" id="cobertura-volumen" name="cobertura-volumen" placeholder="" required>
                                                                </div>
                                                            <div class="col-md-1">
                                                                <span class="help-block">CCE </span>
                                                                <input type="text" class="datos form-control" id="cobro-contra-entrega" name="cobro-contra-entrega" placeholder="">
                                                                </div>
                                                            <div class="col-md-1">
                                                                <span class="help-block">Costo </span>
                                                                <input type="text" class="datos form-control" id="cobertura-costo" name="cobro-contra-entrega" placeholder="">
                                                                </div>
                                   ...
                                   <div class="row">
                                        <div class="col-lg-12">
                                            <div class="card-box">
                                                <div class="widget-chart">
                                                    <H4><strong>Interprovincial</strong></H4>
                                                    <br>
                                                       <div class="row">
                                                            <div class="col-md-2">
                                                                <span class="help-block">Servicio </span>
