                                        ...
                                        <div class="col-lg-12">
                                            <div class="card-box">
                                                <div class="widget-chart">
                                                         ...
                                                         <div class="row">
                                                         <div class="col-md-2">
                                                                <span class="help-block">Remitente </span>
                                                                <select onchange="guardar_destino1(this.value)" class="form-control" id="destino" name="destino">
                                                                    ...
                                                                    while ($row2 = mysqli_fetch_array($query2)) {
                                                                       ...
                                                                       // $nombre_localidad = get_row('localidad', 'parroquia', 'codigo_parroquia', $localidad);
                                                                        ...
                                                                        echo "<option value='$id' > $nombre - $localidad</option>";
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                         ...
                                                         <div class="row">
                                                            <div class="col-md-2">
                                                                <span class="help-block">Destinatario </span>
                                                                <?php
                                                                //echo "select * from bodega where id_empresa=$empresa";
                                                                ?>
                                                                <select class="form-control" onchange="guardar_origen1(this.value)" id="origen" name="origen">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-2">
                                                                ...
                                                                <button style="height: 100%; width: 100%" onclick="calcular_distancia(); " class="btn btn-primary">Calcular</button>
