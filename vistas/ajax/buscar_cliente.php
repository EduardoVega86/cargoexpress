...
while ($row = mysqli_fetch_array($query)) {
            ...
            ?>
                    ...
                    <input type="hidden" value="<?php echo $cargo_contacto; ?>" id="cargo_contacto<?php echo $id_cliente; ?>">
                    <input type="hidden" value="<?php echo $observaciones; ?>" id="observaciones<?php echo $id_cliente; ?>">
                    <input type="hidden" value="<?php echo $giro_negocio; ?>" id="giro_negocio<?php echo $id_cliente; ?>">
